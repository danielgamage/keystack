...
describe(`freqForIndex`, () => {
  it(`fetches correct frequency`, () => {
    expect(freqForIndex(0)).toBe(27.5000) // A0
    expect(freqForIndex(12)).toBe(55.0000) // A1
    expect(freqForIndex(24)).toBe(110.0000) // A2
    expect(freqForIndex(60)).toBe(880.0000) // A5
